...
void zakoncz_proces(PamiecDzielona *pamiec, int id_semaforow) {
    semafor_operacja(id_semaforow, SEM_DOSTEP_PAMIEC, -1);
    pamiec->studenci_zakonczeni++;
    semafor_operacja(id_semaforow, SEM_DOSTEP_PAMIEC, 1);
...
int main(int argc, char *argv[]) {
    ...
    if (ja->zdana_matura == 0) {
        ...
        zakoncz_proces(pamiec, id_semaforow);
    }
